            ...
            for (var c of a.assets)
              if ("layers" in c)
                for (const e of c.layers) {
                  ...
                  const f = [];
                  var d = e.shapes ?? [];
                  for (const g of d) (d = gY(g, b)), f.push(d);
                  e.shapes = f;
                }
          if (a.layers)
            for (const e of a.layers)
              if (e.ty === 4) {
                a = [];
                c = e.shapes ?? [];
                for (const f of c) (c = gY(f, b)), a.push(c);
                e.shapes = a;
              }
        };
        gY = function (a, b) {
...
//# sourceMappingURL=sourcemaps/7d57e0f05969d882.js.map
