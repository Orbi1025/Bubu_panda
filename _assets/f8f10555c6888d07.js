(self["webpackChunk_canva_web"] = self["webpackChunk_canva_web"] || []).push([
  [86064],
  {
    /***/ 775822: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        var Ikc;
        __c.Gkc = function (a, b, c) {
          return new __c.qb(a, c ? __c.rb(c) : void 0, __c.Jaa, {
            ignoreTag: !0,
          }).format(Object.fromEntries(Object.entries(b)));
        };
        __c.Hkc = function (a, b) {
          __c.u(!0);
          __c.u(!0);
          __c.u(!0);
          const { na: c, a: d, b: e } = __c.Rl(a),
            { na: f, a: g, b: h } = __c.Rl(b);
          a = (c + f) / 2;
          ...
          var k = d * (1 + b),
            ...
            n = Math.hypot(l, h);
          b = (m + n) / 2;
          var p = __c.dm((Math.atan2(e, k) * 180) / Math.PI);
          const q = __c.dm((Math.atan2(h, l) * 180) / Math.PI);
        ...
        __c.cz.prototype.i$ = __c.da(18, function () {
          return __c.Yy(this, () => __c.Ky(this.operators, "%", this.value));
        });
        __c.b3 = {
          ...
          hf(a) {
            return __c.pr({
              ...
              action: a.action,
              location: a.location,
              linked_design_id: a.B1b,
              toggle_value: a.FJ,
              editing_context: a.qd == null ? void 0 : __c.qr(a.qd),
              performance_context: a.Gd == null ? void 0 : __c.rr(a.Gd),
              question_type: a.t9b,
            });
          },
        };
